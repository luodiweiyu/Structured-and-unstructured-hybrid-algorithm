...
namespace Init//場宎厙跡
{
	...
	double v0 = 0;
	double p0 = 1;
	double u0 = 0 * sqrt(ConstPara::污 * p0 / 老0);
}
namespace Normal
{
	//double 老1 = 1;
	//double v1 = 0;
	//double p1 = 1;
	//double u1 = 1.1 * sqrt(ConstPara::污 * p1 / 老1);
	//double 老2;
	//double v2;
	//double p2;
	//double u2;
	...
	double v1 = 0;
	double p1 = 4;
	double u1 = 3 * sqrt(ConstPara::污 * p1 / 老1);
...
namespace Couette
{
	...
	double v1 = 0;
	double p1 = 4;
	double u1 = 0.08 * sqrt(ConstPara::污 * p1 / 老1);
...
{
	double 汕 = 50* ConstPara::pi / 180;
	double 老1 = 2;
	double v1 = 0;
	double p1 = 3;
	double u1 = 1.01* sqrt(ConstPara::污 * p1 / 老1);
	int startpoint = MeshPara::Xnum * 3 / 10;
	double Ma1 = get_Ma(u1, v1, 老1, p1);
	double Ma2 = get_Ma2(Ma1, 汕);
	double p2 = get_p2(Ma1, 汕, p1);
	double 老2 = get_老2(Ma1, 汕, 老1);
	double 汛 = get_汛(Ma1, 汕);
...
namespace Prandtl_Meyer//ぱ檄杻闔珖嫌霜雄
{
	...
	double v1 = 0;
	double p1 = 3;
	double u1 = 1.3 * sqrt(ConstPara::污 * p1 / 老1);
	double Ma1 = get_Ma(u1, v1, 老1, p1);
	...
	double u2 = Ma2 * sqrt(p2 * ConstPara::污 / 老2) * cos(汛2);
	double v2 = -Ma2 * sqrt(p2 * ConstPara::污 / 老2) * sin(汛2);
...
namespace ShockwaveCross//慾疏眈蝠
{
	...
	double v1 = 0;
	double p1 = 5;
	double u1 = 10* sqrt(ConstPara::污 * p1 / 老1);
	double 汕2 = -30/ 180.0 * ConstPara::pi;
	double 汕3 = 30/ 180.0 * ConstPara::pi;
	double Ma1 = get_Ma(u1, v1, 老1, p1);

	double Ma2 = get_Ma2(Ma1, 汕2);
	double p2 = get_p2(Ma1, 汕2, p1);
	double 老2 = get_老2(Ma1, 汕2, 老1);
	double 汛2 = get_汛(Ma1, 汕2);
	double u2 = get_ufromMa2(Ma2, 老2, p2, 汛2);
	double v2 = get_vfromMa2(Ma2, 老2, p2, 汛2);

	double Ma3 = get_Ma2(Ma1, 汕3);
	double p3 = get_p2(Ma1, 汕3, p1);
	double 老3 = get_老2(Ma1, 汕3, 老1);
	double 汛3 = get_汛(Ma1, 汕3);
