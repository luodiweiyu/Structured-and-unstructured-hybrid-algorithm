		...
		for (j = 0; j < A[i].size(); j++)
		{
			...
			if (t_sim == 0)
			{
				if (A[i][j]->neibor.size() == 3)
				{
					...
					//A[i][j]->xxi.push_back(0.5 * (A[i][A[i][j]->neibor[0]].x - A[i][A[i][j]->neibor[2]].x));
					//A[i][j]->yxi.push_back(0.5 * (A[i][A[i][j]->neibor[0]].y - A[i][A[i][j]->neibor[2]].y));
					//A[i][j]->xeta.push_back(0.5 * (A[i][A[i][j]->neibor[1]].x - A[i][A[i][j]->neibor[2]].x));
					//A[i][j]->yeta.push_back(0.5 * (A[i][A[i][j]->neibor[1]].y - A[i][A[i][j]->neibor[2]].y));
					...
					//A[i][j]->xxi.push_back(0.5 * (A[i][A[i][j]->neibor[1]].x - A[i][A[i][j]->neibor[0]].x));
					//A[i][j]->yxi.push_back(0.5 * (A[i][A[i][j]->neibor[1]].y - A[i][A[i][j]->neibor[0]].y));
					//A[i][j]->xeta.push_back(0.5 * (A[i][A[i][j]->neibor[2]].x - A[i][A[i][j]->neibor[0]].x));
					//A[i][j]->yeta.push_back(0.5 * (A[i][A[i][j]->neibor[2]].y - A[i][A[i][j]->neibor[0]].y));
					//A[i][j]->J.push_back(1 / (A[i][j]->xxi[1] * A[i][j]->yeta[1] - A[i][j]->xeta[1] * A[i][j]->yxi[1]));
					//A[i][j]->xix.push_back(A[i][j]->yeta[1] * A[i][j]->J[1]);
					//A[i][j]->xiy.push_back(-A[i][j]->xeta[1] * A[i][j]->J[1]);
					//A[i][j]->etax.push_back(-A[i][j]->yxi[1] * A[i][j]->J[1]);
					//A[i][j]->etay.push_back(A[i][j]->xxi[1] * A[i][j]->J[1]);
					//A[i][j]->xτ.push_back(0);
					//A[i][j]->yτ.push_back(0);
					//A[i][j]->xit.push_back(0);
					//A[i][j]->etat.push_back(0);

					//A[i][j]->xxi.push_back(0.5 * (A[i][A[i][j]->neibor[2]].x - A[i][A[i][j]->neibor[1]].x));
					//A[i][j]->yxi.push_back(0.5 * (A[i][A[i][j]->neibor[2]].y - A[i][A[i][j]->neibor[1]].y));
					//A[i][j]->xeta.push_back(0.5 * (A[i][A[i][j]->neibor[0]].x - A[i][A[i][j]->neibor[1]].x));
					//A[i][j]->yeta.push_back(0.5 * (A[i][A[i][j]->neibor[0]].y - A[i][A[i][j]->neibor[1]].y));
					//A[i][j]->J.push_back(1 / (A[i][j]->xxi[2] * A[i][j]->yeta[2] - A[i][j]->xeta[2] * A[i][j]->yxi[2]));
					//A[i][j]->xix.push_back(A[i][j]->yeta[2] * A[i][j]->J[2]);
					//A[i][j]->xiy.push_back(-A[i][j]->xeta[2] * A[i][j]->J[2]);
					//A[i][j]->etax.push_back(-A[i][j]->yxi[2] * A[i][j]->J[2]);
					//A[i][j]->etay.push_back(A[i][j]->xxi[2] * A[i][j]->J[2]);
					//A[i][j]->xτ.push_back(0);
					//A[i][j]->yτ.push_back(0);
					//A[i][j]->xit.push_back(0);
					//A[i][j]->etat.push_back(0);
				...
				else if (A[i][j]->neibor.size() == 4)
				{
					...
					A[i][j]->xxi.push_back(0.5 * (A[i][A[i][j]->neibor1[0]]->x - A[i][A[i][j]->neibor1[2]]->x));
					A[i][j]->yxi.push_back(0.5 * (A[i][A[i][j]->neibor1[0]]->y - A[i][A[i][j]->neibor1[2]]->y));
					A[i][j]->xeta.push_back(0.5 * (A[i][A[i][j]->neibor1[1]]->x - A[i][A[i][j]->neibor1[3]]->x));
					A[i][j]->yeta.push_back(0.5 * (A[i][A[i][j]->neibor1[1]]->y - A[i][A[i][j]->neibor1[3]]->y));
					A[i][j]->J.push_back(1 / (A[i][j]->xxi[1] * A[i][j]->yeta[1] - A[i][j]->xeta[1] * A[i][j]->yxi[1]));
					A[i][j]->xix.push_back(A[i][j]->yeta[1] * A[i][j]->J[1]);
					A[i][j]->xiy.push_back(-A[i][j]->xeta[1] * A[i][j]->J[1]);
					A[i][j]->etax.push_back(-A[i][j]->yxi[1] * A[i][j]->J[1]);
			...
			else//t_sim不等于零时还需要坐标变换，应为动网格！
			{
				if (A[i][j]->neibor.size() == 4)
				{
					...
					A[i][j]->xτ[0] = (A[i][j]->x - Ar[A[i][j]->id].x) / dt;
					A[i][j]->yτ[0] = (A[i][j]->y - Ar[A[i][j]->id].y) / dt;
					A[i][j]->xit[0] = -A[i][j]->xτ[0] * A[i][j]->xix[0] - A[i][j]->yτ[0] * A[i][j]->xiy[0];
					A[i][j]->etat[0] = -A[i][j]->xτ[0] * A[i][j]->etax[0] - A[i][j]->yτ[0] * A[i][j]->etay[0];
				}
				if (A[i][j]->neibor.size() > 4)
				{
					A[i][j]->xxi[0] = 0.5 * (A[i][A[i][j]->neibor1[0]]->x - A[i][A[i][j]->neibor1[2]]->x);
					A[i][j]->yxi[0] = 0.5 * (A[i][A[i][j]->neibor1[0]]->y - A[i][A[i][j]->neibor1[2]]->y);
					A[i][j]->xeta[0] = 0.5 * (A[i][A[i][j]->neibor1[1]]->x - A[i][A[i][j]->neibor1[3]]->x);
					A[i][j]->yeta[0] = 0.5 * (A[i][A[i][j]->neibor1[1]]->y - A[i][A[i][j]->neibor1[3]]->y);
					A[i][j]->J[0] = 1 / (A[i][j]->xxi[0] * A[i][j]->yeta[0] - A[i][j]->xeta[0] * A[i][j]->yxi[0]);
					A[i][j]->xix[0] = A[i][j]->yeta[0] * A[i][j]->J[0];
					A[i][j]->xiy[0] = -A[i][j]->xeta[0] * A[i][j]->J[0];
					A[i][j]->etax[0] = -A[i][j]->yxi[0] * A[i][j]->J[0];
				...
				if (A[i][j]->neibor.size() == 3)
				{
					...
					A[i][j]->xτ[1] = (A[i][j]->x - Ar[A[i][j]->id].x) / dt;
					A[i][j]->yτ[1] = (A[i][j]->y - Ar[A[i][j]->id].y) / dt;
					A[i][j]->xit[1] = -A[i][j]->xτ[1] * A[i][j]->xix[1] - A[i][j]->yτ[1] * A[i][j]->xiy[1];
					A[i][j]->etat[1] = -A[i][j]->xτ[1] * A[i][j]->etax[1] - A[i][j]->yτ[1] * A[i][j]->etay[1];
					...
					A[i][j]->xτ[2] = (A[i][j]->x - Ar[A[i][j]->id].x) / dt;
					A[i][j]->yτ[2] = (A[i][j]->y - Ar[A[i][j]->id].y) / dt;
					A[i][j]->xit[2] = -A[i][j]->xτ[2] * A[i][j]->xix[2] - A[i][j]->yτ[2] * A[i][j]->xiy[2];
					A[i][j]->etat[2] = -A[i][j]->xτ[2] * A[i][j]->etax[2] - A[i][j]->yτ[2] * A[i][j]->etay[2];
